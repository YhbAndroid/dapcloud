package com.dap.cloud.constants;
...
public final class StringConstant {
    ...
    //项目路径（二维码添加域名）
    public static final String WEBSITE = "http://47.104.183.200:80/system";
    //public static final String WEBSITE = "http://localhost:80/system";
	...
	//附件存放路径
	public static final String LAYEDIT_PATH = "D:/nginx/JXVR5G-nginx/web";//存放地址
	public static final String UPLOAD_FILE_URL = "upload"+"/";
	public static final String NGINX_PATH = "D:/nginx/JXVR5G-nginx/web";//nginx路径
